            ...
            <div class="page-container">
                ...
                <div class="input-group">
                    <div class="input-container one-third">
                        <input v-model="name" type="text" placeholder="Activity Name" required>
...
async function addAttraction() {
    try {
        const response = await makeRequest.post('/admin/activities', {
            name: name.value,
...
onMounted(() => {
    // No need to fetch data on Add page
});
</script>