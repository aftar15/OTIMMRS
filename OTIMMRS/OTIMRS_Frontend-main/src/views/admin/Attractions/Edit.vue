            ...
            <div class="page-container">
                ...
                <form v-else @submit.prevent="handleSubmit" class="form-container">
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="image-upload">
                                <div v-if="form.image_url || imagePreview" class="current-image">
                                    <img 
                                        :src="imagePreview || getStorageUrl(form.image_url)" 
                    ...
                    <div class="form-actions">
                        <button type="button" @click="confirmDelete" class="button danger">
                            Delete Attraction
                        </button>
        ...
        <div class="modal" v-if="showDeleteModal">
            <div class="modal-content">
                ...
                <div class="modal-actions">
                    <button @click="showDeleteModal = false" class="button secondary">Cancel</button>
                    <button @click="handleDelete" class="button danger">Delete</button>
                </div>
            </div>
        </div>
    </div>
...
const fetchAttraction = async () => {
    try {
        loading.value = true;
        const response = await AttractionService.getAttraction(route.params.id);
...
const handleSubmit = async () => {
    try {
        ...
        await AttractionService.updateAttraction(route.params.id, formData);
...
const handleDelete = async () => {
    try {
        loading.value = true;
        await AttractionService.deleteAttraction(route.params.id);
